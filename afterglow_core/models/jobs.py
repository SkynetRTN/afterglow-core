...
class JobResult(AfterglowSchema):
    ...
    class MyJobResult(JobResult):
        ...
        value2 = fields.Float()
    """
    errors: TList[TDict[str, Union[str, int, float, bool]]] = List(Nested(AfterglowErrorSchema))
    warnings: TList[str] = List(String())
    files: TDict[str, JobFile] = Dict(String, Nested(JobFile), dump_default={})
...
class Job(AfterglowSchema):
    ...
    Methods::
        ...
        create_job_file(): save data to an extra job data file and register in JobResult.files
    """
    ...
    def __init__(self, *args, _task: Task = None, **kwargs):
        """
        ...
        :param _task: Celery task instance used to pass job state updates
    ...
    def create_job_file(self, id: Union[int, str], data: bytes,
                        ...
                        headers: Optional[TDict[str, str]] = None) -> None:
        """
        Create a new extra job file to be returned by GET /jobs/[id]/result/files
        ...
        :param headers: optional extra headers to be returned by GET /jobs/[id]/result/files
        """
