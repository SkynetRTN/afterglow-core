...
__all__ = [
    'AnonymousUser', 'Role', 'User', 'PersistentToken', 'UserClient',
    'db', 'user_datastore',
]


Role = User = PersistentToken = UserClient = db = user_datastore = None
...
def _init_users():
    ...
    global Role, User, PersistentToken, UserClient, db, user_datastore
    ...
    class _Role(db.Model, RoleMixin):
        __tablename__ = 'roles'
    ...
    class _PersistentToken(db.Model):
    ...
    PersistentToken = _PersistentToken
